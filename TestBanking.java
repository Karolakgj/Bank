...
public class TestBanking {
    ...
    public static void main(String[] args) {
        ...
        bank.addCustomer("Jan", "Kowalsky");
        bank.addCustomer("Stan", "Abacki");
        bank.addCustomer("Miroslaw", "Nowak");
        bank.addCustomer("Marysia", "Brzozowska");
        bank.addCustomer("Katarzyna", "Lecka");
